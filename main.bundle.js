...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './status.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './data.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './dragdrop.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './addremoveedit.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\n\n\n\n\n\nlet todolist = [];\nif (localStorage.getItem('information') === null) {\n  localStorage.setItem('information', '[]');\n}\nclass Tasks {\n  constructor() {\n    this.toDoList = null;\n  }\n\n  setTodo(todolist) {\n    this.todo = todolist;\n  }\n\n  getTodo() {\n    return this.todo;\n  }\n}\nconst lists = new Tasks();\nconst todoDiv = document.querySelector('.lists');\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './dragdrop.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(todoDiv);\nlet i = 0;\nconst getTodoList = () => {\n  todolist.forEach((list) => {\n    const li = document.createElement('li');\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './dragdrop.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(li);\n    li.classList.add('list');\n    li.classList.add('draggable');\n    li.id = i;\n    li.draggable = true;\n    const liDiv = document.createElement('div');\n    liDiv.classList.add('li-div');\n    // create checkbox\n    const checkbox = document.createElement('input');\n    checkbox.classList.add('checkbox');\n    checkbox.type = 'checkbox';\n    checkbox.checked = list.completed;\n    liDiv.appendChild(checkbox);\n    // create description\n    const desc = document.createElement('input');\n    desc.classList.add('desc');\n    desc.value = list.description;\n    desc.onchange = () => {\n      Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './addremoveedit.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(desc);\n    };\n    liDiv.appendChild(desc);\n    checkbox.addEventListener('change', function check() {\n      if (this.checked) {\n        desc.classList.add('line');\n      } else {\n        desc.classList.remove('line');\n      }\n    });\n    li.appendChild(liDiv);\n    // create 3 vertical dots\n    const dots = document.createElement('i');\n    dots.classList.add('fa');\n    dots.classList.add('fa-ellipsis-v');\n    li.appendChild(dots);\n    todoDiv.appendChild(li);\n    // create trashcan\n    const trash = document.createElement('i');\n    trash.classList.add('fa');\n    trash.id = `trashcan${i}`;\n    trash.classList.add('fa-trash');\n    trash.addEventListener('click', () => {\n      todolist = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './addremoveedit.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(trash);\n      Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './addremoveedit.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(todoDiv);\n      window.location.reload();\n    });\n    dots.addEventListener('click', () => {\n      dots.classList.add('hidden');\n      trash.classList.remove('hidden');\n    });\n    trash.classList.add('hidden');\n    li.appendChild(trash);\n    todoDiv.appendChild(li);\n    i += 1;\n  });\n  const cbox = document.querySelectorAll('.checkbox');\n  cbox.forEach((chbox) => {\n    chbox.addEventListener('change', Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './status.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\n  });\n};\nconst todoInput = document.getElementById('todo-input');\ntodoInput.addEventListener('keydown', (e) => {\n  if (e.key === 'Enter') {\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './addremoveedit.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(todoInput.value);\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './addremoveedit.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(todoDiv);\n    const get = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './data.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();\n    lists.setTodo(get);\n    window.location.reload();\n  }\n});\nconst clearBtn = document.getElementById('btn');\nclearBtn.addEventListener('click', () => {\n  Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './addremoveedit.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();\n  const get = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './data.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();\n  Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './addremoveedit.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(todoDiv);\n  lists.setTodo(get);\n  window.location.reload();\n});\nwindow.addEventListener('DOMContentLoaded', () => {\n  if (localStorage.getItem('information')) {\n    todolist = JSON.parse(localStorage.getItem('information'));\n  } else {\n    localStorage.setItem(\n      'information',\n      JSON.stringify(todolist.sort((a, b) => +a.index - +b.index)),\n    );\n  }\n\n  getTodoList(todolist.sort((a, b) => +a.index - +b.index));\n});\n\n\n//# sourceURL=webpack://webpack-template/./src/index.js?");
